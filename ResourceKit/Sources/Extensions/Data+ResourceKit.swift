...
public extension Data {
    ...
    /**
     ...
     This computed instance property renders its associated `Data` value into a
     Unicode string. This can be useful when reviewing the content of a byte
     buffer, such as when downloading a JSON object from a REST API service.
     */
    ...
    /**
     ...
     an object adopting the `Decodable` protocol.  The decoder used must conform
